...
const initialEmployeesBase = [
    ...
    { nom: 'MARTIN', prenom: 'Sophie', id: 11, groupId: 1, type: 'employee', pole: 1, code: 'EMP-011', role: 'viewer', theme: 'light' , actif: true},
    { nom: 'DUBOIS', prenom: 'Antoine', id: 13, groupId: 1, type: 'interim', pole: 1, code: 'EMP-013', role:'user' , theme:'dark', actif: false},
    { nom:'LEROY', prenom:'Marie', id : 14, groupId : 1 , type : "employee", pole : 1 , code : "EMP-014", role : "user", theme : "light", email : "marie.leroy@entreprise.fr", actif: true},
    { nom: 'MOREAU', prenom: 'Vincent', id: 15, groupId: 1, type: 'employee', pole: 1, code: 'EMP-015', role: 'user', theme: 'dark', actif: true },
    { nom: 'GARCIA', prenom: 'Céline', id: 16, groupId: 1, type: 'interim', pole: 1, code: 'EMP-016', role:'user' , theme:'light', actif: true},
    
    // Équipe Commercial
    { nom: 'BOURDIN', prenom: 'Lucas', id: 3, groupId: 2, type: 'interim', image: 37, pole: 2, code: 'EMP-003', role: 'user', theme: 'light', actif: true},
    { nom: 'ZERR', prenom: 'Romain', id: 4, groupId: 2,  type: 'employee', pole: 2 , code: 'EMP-004', role: 'user', theme: 'dark', actif: true},
    { nom: 'BERNARD', prenom: 'Lucas', id: 8, groupId: 2,  type: 'employee', pole: 2 , code: 'EMP-008', role: 'user', theme: 'light', actif: false},
    { nom: 'PETIT', prenom: 'Julien', id: 12, groupId: 2, type: 'interim', pole: 2 , code: 'EMP-012', role:'user' , theme:'dark', actif: true},
    { nom: 'ROBERT', prenom: 'Nathalie', id: 17, groupId: 2, type: 'employee', pole: 2 , code: 'EMP-017', role:'user' , theme:'light', actif: true},
    { nom: 'RICHARD', prenom: 'David', id: 18, groupId: 2, type: 'employee', pole: 2 , code: 'EMP-018', role:'user' , theme:'dark', actif: true},
    { nom: 'DURAND', prenom: 'Isabelle', id: 19, groupId: 2, type: 'interim', pole: 2 , code: 'EMP-019', role:'user' , theme:'light', actif: false},
    { nom: 'LEFEBVRE', prenom: 'Stéphane', id: 20, groupId: 2, type: 'employee', pole: 2 , code: 'EMP-020', role:'user' , theme:'dark', actif: true},
    
    // Équipe Administrative
    { nom: 'DACHAUD', prenom: 'Fabrice', id: 5, groupId: 3, type: 'employee', pole: 3, code: 'EMP-005', role:'user' , theme:'light' , actif: true},
    { nom: 'GERMAIN', prenom: 'Sébastien', id: 6, groupId: 3, type: 'employee', pole: 3 , code: 'EMP-006', role:'user' , theme:'dark', actif: true},
    { nom: 'SIMON', prenom: 'Caroline', id: 21, groupId: 3, type: 'employee', pole: 3 , code: 'EMP-021', role:'user' , theme:'light', actif: true},
    { nom: 'MICHEL', prenom: 'Philippe', id: 22, groupId: 3, type: 'interim', pole: 3 , code: 'EMP-022', role:'user' , theme:'dark', actif: true},
    { nom: 'LAURENT', prenom: 'Valérie', id: 23, groupId: 3, type: 'employee', pole: 3 , code: 'EMP-023', role:'user' , theme:'light', actif: true},
    { nom: 'LEFRANC', prenom: 'Patrick', id: 24, groupId: 3, type: 'employee', pole: 3   , code: 'EMP-024', role:'user' , theme:'dark', actif: true},
    
    // Équipe RH
    { nom: 'ROUSSEAU', prenom: 'Emma', id: 9, groupId: 4,  type: 'employee', pole: 4, code: 'EMP-009', role:'user' , theme:'light', actif: true},
    { nom: 'VINCENT', prenom: 'Paul', id: 10, groupId: 4, type: 'interim', pole: 4 , code: 'EMP-010', role:'user' , theme:'dark', actif: true},
    { nom: 'THOMAS', prenom: 'Sandrine', id: 25, groupId: 4, type: 'employee', pole: 4 , code: 'EMP-025', role:'user' , theme:'light', actif: true},
    { nom: 'BONNET', prenom: 'Christophe', id: 26, groupId: 4, type: 'employee', pole: 4 , code: 'EMP-026', role:'user' , theme:'dark', actif: true},
    { nom: 'FRANCOIS', prenom: 'Sylvie', id: 27, groupId: 4, type: 'interim', pole: 4 , code: 'EMP-027', role:'user' , theme:'light', actif: true},
    
    // Nouvelles équipes
    { nom: 'GIRARD', prenom: 'Marine', id: 28, groupId: 5, type: 'employee', pole: 1, code: 'EMP-028', role:'user' , theme:'dark', actif: true},
    { nom: 'ANDRE', prenom: 'Pierre', id: 29, groupId: 6, type: 'employee', pole: 2, code: 'EMP-029', role:'user' , theme:'light', actif: true},
    { nom: 'NICOLAS', prenom: 'Sylvie', id: 30, groupId: 7, type: 'employee', pole: 3 , code: 'EMP-030', role:'user' , theme:'dark', actif: true},
    { nom: 'MOREL', prenom: 'Thomas', id: 31, groupId: 8, type: 'employee', pole: 1 , code: 'EMP-031', role:'user' , theme:'light', actif: true},
    { nom: 'FOURNIER', prenom: 'Julie', id: 32, groupId: 5, type: 'interim', pole: 1 , code: 'EMP-032', role:'user' , theme:'dark', actif: true},
    { nom: 'MORETTI', prenom: 'Olivier', id: 33, groupId: 6, type: 'employee', pole: 2 , code: 'EMP-033', role:'user' , theme:'light', actif: true},
    { nom: 'ROUSSEL', prenom: 'Patricia', id: 34, groupId: 7, type: 'employee', pole: 3 , code: 'EMP-034', role:'user' , theme:'dark', actif: true},
    { nom: 'GERARD', prenom: 'Frédéric', id: 35, groupId: 8, type: 'interim', pole: 1, code: "EMP-035", role: "user", theme: "light", actif: true },


    { nom: 'GERARD', prenom: 'Frédéric', id: 44, type: 'employee', pole: 2, code: 'EMP-044', role:'user' , theme:'dark', actif: true},
    { nom: 'DUPONT', prenom: 'Jean', id: 36, type: 'employee', pole: 2 , code: 'EMP-036', role:'user' , theme:'light' , actif: true},
    { nom: 'DUBOIS', prenom: 'Marie', id: 37, type: 'employee', pole: 2, code: 'EMP-037' , role:'user' , theme:'dark', actif: true},
    { nom: 'MOREAU', prenom: 'Luc', id: 38, type: 'employee', pole: 2 , code: 'EMP-038', role:'user' , theme:'light', actif: true},
    { nom: 'LEROY', prenom: 'Sophie', id: 39, type: 'employee', pole: 2 , code: 'EMP-039', role:'user' , theme:'dark', actif: true},
    { nom: 'ROUSSEAU', prenom: 'Marc', id: 40, type: 'employee', pole: 2 , code: 'EMP-040', role:'user' , theme:'light', actif: true},
    { nom: 'GARCIA', prenom: 'Céline', id: 41, type: 'employee', pole: 2 , code: 'EMP-041', role:'user' , theme:'dark', actif: true},
    { nom: 'MALIVERNAY', prenom: 'Eric', id: 42, type: 'employee', pole: 2 , code : "EMP-042", role:"user", theme:"light", actif: true},
    { nom: 'MARTIN', prenom: 'Sophie', id: 43, type: 'employee', pole: 2 , code: 'EMP-043', role:'user' , theme:'dark', actif: true},

    { nom: 'FAURE', prenom: 'Julien', id: 45, groupId: 1, type: 'employee', pole: 1, code: 'EMP-045', role:'user' , theme:'light', actif: true},
    { nom: 'BLANC', prenom: 'Benoît', id: 46, groupId: 1, type: 'interim', pole: 1, code: 'EMP-046', role:'user' , theme:'dark', actif: true},
    { nom: 'PONT', prenom: 'Aurélie', id: 47, groupId: 1, type: 'employee', pole: 1, code: 'EMP-047', role:'user' , theme:'light', actif: true},
    { nom: 'GUERIN', prenom: 'Lucas', id: 48, groupId: 5, type: 'employee', pole: 1, code: 'EMP-048', role:'user' , theme:'dark', actif: true},
    { nom: 'MULLER', prenom: 'Kevin', id: 49, groupId: 5, type: 'interim', pole: 1, code: 'EMP-049', role:'user' , theme:'light', actif: true},
    { nom: 'SCHMITT', prenom: 'Sarah', id: 50, groupId: 8, type: 'employee', pole: 1, code : "EMP-050", role:"user", theme:"dark", actif: true},
    { nom: 'LEMAIRE', prenom: 'Thomas', id :51 , groupId :8 , type : "employee", pole :1 , code :"EMP-051", role:"user", theme:"light", actif: true},
    { nom : "ROBIN", prenom : "Emma", id :52 , groupId :6 , type :"employee", pole :2 , code :"EMP-052", role:"user", theme:"dark", actif: true},
    { nom: 'PICARD', prenom: 'Nicolas', id: 53, groupId: 6, type: 'employee', pole: 2, code: 'EMP-053', role:'user' , theme:'light', actif: true},
    { nom: 'RIVIERE', prenom: 'Laura', id: 54, groupId: 2, type: 'employee', pole: 2, code: 'EMP-054', role:'user' , theme:'dark', actif: true},
    { nom: 'MARCHAND', prenom: 'Antoine', id: 55, groupId: 2, type: 'interim', pole: 2, code: 'EMP-055', role:'user' , theme:'light', actif: true},
    { nom: 'DUPUIS', prenom: 'Chloé', id: 56, groupId: 3, type: 'employee', pole: 3, code: 'EMP-056', role:'user' , theme:'dark', actif: true},
    { nom: 'LAMBERT', prenom: 'Juliette', id: 57, groupId: 3, type: 'employee', pole: 3, code: 'EMP-057', role:'user' , theme:'light', actif: true},
    { nom: 'CLEMENT', prenom: 'Julien', id: 58, groupId: 4, type: 'employee', pole: 4, code: 'EMP-058', role: 'user', theme: 'dark', actif: true},
    { nom: 'GUILLAUME', prenom: 'Sophie', id: 59, groupId: 4, type: 'interim', pole: 4, code: 'EMP-059', role: 'user', theme: 'dark', actif: true},
    { nom : "LEDUC", prenom : "Mathieu", id :60 , groupId :4 , type :"employee", pole :4 , code :"EMP-060", role:"user", theme:"light", actif: true},
    { nom : "FERNANDEZ", prenom : "Isabelle", id :61 , groupId :7 , type :"employee", pole :3 , code :"EMP-061", role:"user", theme:"dark", actif: true},
    { nom : "MARTINEZ", prenom : "Sébastien", id :62 , groupId :7 , type :"employee", pole :3 , code :"EMP-062", role:"user", theme:"light", actif: true},
    { nom: 'DAVID', prenom: 'Céline', id: 63, groupId: 6, type: 'employee', pole: 2, code: 'EMP-063', role:'user' , theme:'dark', actif: true},
    { nom: 'JACQUET', prenom: 'Vincent', id: 64, groupId: 5, type: 'employee', pole: 1, code: 'EMP-064', role:'user' , theme:'light', actif: true},
    { nom: 'LOPEZ', prenom: 'Amélie', id: 65, groupId: 8, type: 'interim', pole: 1, code: 'EMP-065', role:'user' , theme:'dark', actif: true},
    { nom: 'FOUCAULT', prenom: 'Cédric', id: 66, groupId: 1, type: 'employee', pole: 1, code: 'EMP-066', role:'user' , theme:'light', actif: true},
    { nom: 'MARTY', prenom: 'Aline', id: 67, groupId: 2, type: 'employee', pole: 2, code: 'EMP-067', role:'user' , theme:'dark', actif: true},
    { nom: 'LEBLANC', prenom: 'Bruno', id: 68, groupId: 3, type: 'employee', pole: 3, code: 'EMP-068', role:'user' , theme:'light', actif: true},
    { nom: 'GARNIER', prenom: 'Catherine', id: 69, groupId: 4, type: 'interim', pole: 4, code: 'EMP-069', role: 'user', theme: 'dark', actif: true},
    { nom: 'CARTER', prenom: 'David', id: 70, groupId: 5, type: 'employee', pole: 1, code: 'EMP-070', role:'user' , theme:'light', actif: true},
    { nom: 'WILLIAMS', prenom: 'Laura', id: 71, groupId: 6, type: 'employee', pole: 2, code: 'EMP-071', role:'user' , theme:'dark', actif: true},
    { nom: 'JONES', prenom: 'Kevin', id: 72, groupId: 7, type: 'employee', pole: 3, code: 'EMP-072', role:'user' , theme:'light', actif: true},
    { nom: 'BROWN', prenom: 'Sophie', id: 73, groupId: 8, type: 'interim', pole: 1, code: 'EMP-073', role:'user' , theme:'dark', actif: true},
    { nom: 'DAVIS', prenom: 'Thomas', id: 74, groupId: 1, type: 'employee', pole: 1, code: 'EMP-074', role:'user' , theme:'light', actif: true},
    { nom: 'MILLER', prenom: 'Emma', id: 75, groupId: 2, type: 'employee', pole: 2, code: 'EMP-075', role:'user' , theme:'dark', actif: true},
    { nom : "WILSON", prenom : "Lucas", id :76 , groupId :3 , type :"employee", pole :3 , code :"EMP-076", role:"user", theme:"light", actif: true},
    { nom : "MOORE", prenom : "Chloé", id :77 , groupId :4 , type :"interim", pole :4 , code :"EMP-077", role:"user", theme:"dark", actif: true},
    { nom : "TAYLOR", prenom : "Antoine", id :78 , groupId :5 , type :"employee", pole :1 , code :"EMP-078", role:"user", theme:"light", actif: true},
    { nom: 'ANDERSON', prenom: 'Julie', id: 79, groupId: 6, type: 'employee', pole: 2, code: 'EMP-079', role: 'user', theme: 'dark', actif: true},
    { nom: 'THOMAS', prenom: 'Nicolas', id: 80, groupId: 7, type: 'employee', pole: 3, code: 'EMP-080', role:'user' , theme:'light', actif: true},
    { nom: 'JACKSON', prenom: 'Isabelle', id: 81, groupId: 8, type: 'interim', pole: 1, code: 'EMP-081', role:'user' , theme:'dark', actif: true},
    { nom: 'WHITE', prenom: 'David', id: 82, groupId: 1, type: 'employee', pole: 1, code: 'EMP-082', role:'user' , theme:'light', actif: true},
    { nom: 'HARRIS', prenom: 'Sophie', id: 83, groupId: 2, type: 'employee', pole: 2, code: 'EMP-083', role:'user' , theme:'dark', actif: true},
    { nom: 'SANCHEZ', prenom: 'Julien', id: 84, groupId: 3, type: 'employee', pole: 3, code: 'EMP-084', role:'user' , theme:'light', actif: true},
    { nom : "CLARK", prenom : "Emma", id :85 , groupId :4 , type :"interim", pole :4 , code :"EMP-085", role:"user", theme:"dark", actif: true},
    { nom : "RAMIREZ", prenom : "Lucas", id :86 , groupId :5 , type :"employee", pole :1 , code :"EMP-086", role:"user", theme:"light", actif: true},
    { nom : "LEWIS", prenom : "Laura", id :87 , groupId :6 , type :"employee", pole :2 , code :"EMP-087", role:"user", theme:"dark", actif: true},
    { nom : "ROBINSON", prenom : "Kevin", id :88 , groupId :7 , type :"employee", pole :3 , code :"EMP-088", role:"user", theme:"light", actif: true},
    { nom: 'WALKER', prenom: 'Sophie', id: 89, groupId: 8, type: 'interim', pole: 1, code: 'EMP-089', role:'user' , theme:'dark', actif: true},
    { nom: 'YOUNG', prenom: 'Thomas', id: 90, groupId: 1, type: 'employee', pole: 1, code: 'EMP-090', role:'user' , theme:'light', actif: true},
    { id: 91, nom: 'HERNANDEZ', prenom: 'Chloé', type: 'employee', pole: 2, code: 'EMP-091', role:'user' , theme:'dark', actif: true},
    { id: 92, nom: 'KING', prenom: 'Antoine', type: 'employee', pole: 2, code: 'EMP-092', role:'user' , theme:'light', actif: true},
    { id: 93, nom: 'WRIGHT', prenom: 'Julie', type: 'employee', pole: 2, code: 'EMP-093', role:'user' , theme:'dark', actif: true},
    { id: 94, nom: 'LOPEZ', prenom: 'Nicolas', type: 'employee', pole: 2, code: 'EMP-094', role:'user' , theme:'light', actif: true},
    { id: 95, nom: 'HILL', prenom: 'Isabelle', type: 'employee', pole: 2, code: 'EMP-095', role:'user' , theme:'dark', actif: true},
    { id: 96, nom: 'SCOTT', prenom: 'David', type: 'employee', pole: 2, code: 'EMP-096', role:'user' , theme:'light', actif: true},
    { id: 97, nom : "GREEN", prenom : "Sophie" , groupId :1 , type :"employee", pole :3 , code :"EMP-097", role:"user", theme:"dark", actif: true},
    { id : 98, nom : "ADAMS", prenom : "Julien", type :"employee", pole :4 , code :"EMP-098", role:"user", theme:"light", actif: true},
    { id: 99, nom: 'BAKER', prenom: 'Emma', type: 'employee', pole: 2, code: 'EMP-099', role: 'user', theme: 'dark', actif: true},
    { id: 100, nom: 'GONZALEZ', prenom: 'Lucas', type: 'employee', pole: 2, code: 'EMP-100', role:'user' , theme:'light' , actif: true},
    { nom: 'LEE', prenom: 'Laura', id: 101, type: 'employee', pole: 2, code: 'EMP-101', role:'user' , theme:'dark' , actif: true},
    { nom: 'HARRISON', prenom: 'Kevin', id: 102, type: 'employee', pole: 2, code: 'EMP-102', role:'user' , theme:'light' , actif: true},
    { nom: 'SULLIVAN', prenom: 'Sophie', id: 103, type: 'employee', pole: 2, code: 'EMP-103', role:'user' , theme:'dark', actif: true},
    { nom: 'MURPHY', prenom: 'Antoine', id: 104, type: 'employee', pole: 2, code: 'EMP-104', role:'user' , theme:'light', actif: true},
    { nom: 'COOK', prenom: 'Julie', id: 105, type: 'employee', pole: 2, code: 'EMP-105', role:'user' , theme:'dark', actif: true},
    { nom: 'ROGERS', prenom: 'Nicolas', id: 106, type: 'employee', pole: 2, code: 'EMP-106', role:'user' , theme:'light', actif: true},
    { nom : "REED", prenom : "Isabelle", id :107 , groupId :7 , type :"employee", pole :4 , code :"EMP-107", role:"user", theme:"dark", actif: true},
    { nom : "COOPER", prenom : "David", id :108 , groupId :8 , type :"employee", pole :3 , code :"EMP-108", role:"user", theme:"light", actif: true},
    { nom: 'MORGAN', prenom: 'Sophie', id: 109, type: 'employee', pole: 2, code: 'EMP-109', role:'user' , theme:'dark', actif: true},
    { nom: 'BELL', prenom: 'Julien', id: 110, type: 'employee', pole: 2, code: 'EMP-110', role:'user' , theme:'light', actif: true},
    { nom: 'MURRAY', prenom: 'Emma', id: 111, type: 'employee', pole: 2, code: 'EMP-111', role:'user' , theme:'dark', actif: true},
    { nom: 'BAILEY', prenom: 'Lucas', id: 112, type: 'employee', pole: 2, code: 'EMP-112', role:'user' , theme:'light', actif: true},
];
