...
export const Evenements: Evenement[] = [
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Julien MARTIN',
      chefChantier: 'Patrick LEROY',
      dateOS: '01/03/2024',
      dateFin: '01/11/2025',
      TM: '3400h',
      HR: '1360h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Camille DURAND',
      chefChantier: 'Nicolas FABRE',
      dateOS: '15/06/2024',
      dateFin: '15/09/2025',
      TM: '5200h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Claire JOLY',
      chefChantier: 'Thomas BERNARD',
      dateOS: '01/02/2024',
      dateFin: '01/03/2026',
      TM: '7600h',
      HR: '3800h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Laurent MEUNIER',
      chefChantier: 'David SIMON',
      dateOS: '01/09/2024',
      dateFin: '01/06/2026',
      TM: '4100h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Hugo CARLIER',
      chefChantier: 'Sylvain DUMONT',
      dateOS: '15/03/2024',
      dateFin: '15/07/2025',
      TM: '6200h',
      HR: '3720h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Manon LAFON',
      chefChantier: 'Arnaud RIVIÈRE',
      dateOS: '01/05/2024',
      dateFin: '01/11/2025',
      TM: '4500h',
      HR: '2250h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Elodie MOREL',
      chefChantier: 'Gérald PETIT',
      dateOS: '01/10/2024',
      dateFin: '01/07/2026',
      TM: '5300h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Adrien PERRIN',
      chefChantier: 'Léa CLEMENT',
      dateOS: '01/04/2024',
      dateFin: '01/10/2025',
      TM: '4000h',
      HR: '1800h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Terminé',
      chargeAffaire: 'Julie MAROT',
      chefChantier: 'Philippe LUCAS',
      dateOS: '01/02/2023',
      dateFin: '01/05/2024',
      TM: '3100h',
      HR: '3100h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Damien BONNEAU',
      chefChantier: 'Paul GAUTHIER',
      dateOS: '15/01/2024',
      dateFin: '15/06/2025',
      TM: '5400h',
      HR: '2700h',
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Nathalie LAMBERT',
      chefChantier: 'Antoine GAUTIER',
      dateOS: '01/04/2024',
      dateFin: '01/02/2025',
      TM: '2800h',
      HR: '1820h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Chloé HENRY',
      chefChantier: 'Benoît ROLLAND',
      dateOS: '01/09/2024',
      dateFin: '01/06/2026',
      TM: '3900h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Florian ROUX',
      chefChantier: 'Vincent PERRET',
      dateOS: '15/03/2024',
      dateFin: '15/12/2025',
      TM: '5800h',
      HR: '2320h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Olivier GARNIER',
      chefChantier: 'Julie COLLIN',
      dateOS: '01/10/2024',
      dateFin: '01/06/2026',
      TM: '4600h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Isabelle PERRAUD',
      chefChantier: 'Jean-Pierre MICHEL',
      dateOS: '01/03/2024',
      dateFin: '01/02/2025',
      TM: '2900h',
      HR: '2100h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Matthieu GILLET',
      chefChantier: 'Eric VIVIER',
      dateOS: '01/08/2024',
      dateFin: '01/04/2026',
      TM: '6300h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Charlotte DUBOIS',
      chefChantier: 'Marc LAMBERT',
      dateOS: '01/02/2024',
      dateFin: '01/12/2025',
      TM: '3100h',
      HR: '1550h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Bastien MARCHAND',
      chefChantier: 'Lucien MORET',
      dateOS: '15/05/2024',
      dateFin: '15/02/2026',
      TM: '3800h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Sébastien LEROY',
      chefChantier: 'Olivier RIVET',
      dateOS: '01/01/2024',
      dateFin: '01/10/2025',
      TM: '4800h',
      HR: '1920h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Aurélie DUPONT',
      chefChantier: 'Xavier GARNIER',
      dateOS: '15/02/2024',
      dateFin: '15/08/2025',
      TM: '7200h',
      HR: '3600h',
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Mathilde LAFITTE',
      chefChantier: 'Jean DUFRESNE',
      dateOS: '01/09/2024',
      dateFin: '01/05/2026',
      TM: '4200h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Thomas VERNET',
      chefChantier: 'Corinne LEROY',
      dateOS: '01/03/2024',
      dateFin: '01/11/2025',
      TM: '6900h',
      HR: '3100h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Lucas GUILLOT',
      chefChantier: 'Camille BONNET',
      dateOS: '01/04/2024',
      dateFin: '01/12/2025',
      TM: '5700h',
      HR: '2600h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Sophie LEMOINE',
      chefChantier: 'Maxime DUMAS',
      dateOS: '01/06/2024',
      dateFin: '01/03/2026',
      TM: '3900h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Hélène FONTAINE',
      chefChantier: 'Romain DESCHAMPS',
      dateOS: '15/02/2024',
      dateFin: '15/08/2025',
      TM: '5100h',
      HR: '2550h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Claire LAMBERT',
      chefChantier: 'Geoffroy BLANCHET',
      dateOS: '01/07/2024',
      dateFin: '01/04/2026',
      TM: '4800h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Vincent LEGRAND',
      chefChantier: 'Damien ROLLIN',
      dateOS: '01/03/2024',
      dateFin: '01/10/2025',
      TM: '3600h',
      HR: '1800h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Amandine JOURDAN',
      chefChantier: 'Laurent GIRAUD',
      dateOS: '01/01/2024',
      dateFin: '01/12/2025',
      TM: '4400h',
      HR: '3080h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Terminé',
      chargeAffaire: 'François MOREAU',
      chefChantier: 'Yann DELORME',
      dateOS: '01/01/2023',
      dateFin: '01/04/2024',
      TM: '3800h',
      HR: '3800h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Nicolas MARIN',
      chefChantier: 'Thomas VIAL',
      dateOS: '01/09/2024',
      dateFin: '01/05/2026',
      TM: '5000h',
      HR: '0h',
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Léa RICHARD',
      chefChantier: 'Julien MASSON',
      dateOS: '01/03/2024',
      dateFin: '01/09/2025',
      TM: '6400h',
      HR: '3200h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Damien LEROY',
      chefChantier: 'Amélie GARNIER',
      dateOS: '01/07/2024',
      dateFin: '01/05/2026',
      TM: '7200h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Camille MARTY',
      chefChantier: 'Olivier DUJARDIN',
      dateOS: '15/02/2024',
      dateFin: '15/12/2025',
      TM: '5300h',
      HR: '2120h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Élodie CHARLES',
      chefChantier: 'Franck BERTRAND',
      dateOS: '01/06/2024',
      dateFin: '01/02/2026',
      TM: '3800h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Jérôme LAFON',
      chefChantier: 'Bastien REY',
      dateOS: '01/04/2024',
      dateFin: '01/09/2025',
      TM: '4700h',
      HR: '2350h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Hugo MARTIN',
      chefChantier: 'David GROSJEAN',
      dateOS: '01/05/2024',
      dateFin: '01/03/2026',
      TM: '3900h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Valérie DUPRÉ',
      chefChantier: 'Anthony MAUREL',
      dateOS: '01/02/2024',
      dateFin: '01/10/2025',
      TM: '3500h',
      HR: '1750h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Claire DESCHAMPS',
      chefChantier: 'Yannick LACROIX',
      dateOS: '01/03/2024',
      dateFin: '01/12/2025',
      TM: '7100h',
      HR: '3550h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Isabelle MARTEL',
      chefChantier: 'Raphaël FOUQUET',
      dateOS: '01/08/2024',
      dateFin: '01/06/2026',
      TM: '4100h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Benoît FAVRE',
      chefChantier: 'Patricia REYNAUD',
      dateOS: '01/04/2024',
      dateFin: '01/10/2025',
      TM: '6400h',
      HR: '3200h',
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Lucie GIRAUD',
      chefChantier: 'Romain BONNET',
      dateOS: '01/03/2024',
      dateFin: '01/10/2025',
      TM: '4300h',
      HR: '2150h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Pauline MARTIN',
      chefChantier: 'Léo BERNARD',
      dateOS: '01/09/2024',
      dateFin: '01/07/2026',
      TM: '3900h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Éric BOUCHER',
      chefChantier: 'Sébastien LAFAYE',
      dateOS: '15/02/2024',
      dateFin: '15/09/2025',
      TM: '6200h',
      HR: '3720h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Delphine BERTIN',
      chefChantier: 'Yves ROUX',
      dateOS: '01/08/2024',
      dateFin: '01/04/2026',
      TM: '3100h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Sophie PEREZ',
      chefChantier: 'Julien PETIT',
      dateOS: '01/04/2024',
      dateFin: '01/12/2025',
      TM: '4800h',
      HR: '1920h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Claire GIRARD',
      chefChantier: 'Thomas NOIR',
      dateOS: '01/06/2024',
      dateFin: '01/06/2026',
      TM: '5200h',
      HR: '0h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Olivier LENOIR',
      chefChantier: 'Bastien MERCIER',
      dateOS: '01/03/2024',
      dateFin: '01/11/2025',
      TM: '6100h',
      HR: '3050h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Terminé',
      chargeAffaire: 'Nathalie DUMAS',
      chefChantier: 'Xavier MARCHAND',
      dateOS: '01/09/2023',
      dateFin: '01/04/2024',
      TM: '3500h',
      HR: '3500h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'En cours',
      chargeAffaire: 'Jean-Luc FAVIER',
      chefChantier: 'Hugo MAHE',
      dateOS: '01/01/2024',
      dateFin: '01/09/2025',
      TM: '6700h',
      HR: '3350h',
  ...
  },
  {
    ...
    attributs: {
      ...
      etat: 'Planifié',
      chargeAffaire: 'Catherine MARTEL',
      chefChantier: 'Lionel BRUN',
      dateOS: '01/07/2024',
      dateFin: '01/05/2026',
      TM: '4600h',
      HR: '0h',
